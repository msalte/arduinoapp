...
export const PhoneLandscape = ({ children, ...props }) => {
    return (
        <MediaQuery maxWidth={phoneMaxWidth} orientation={"landscape"} {...props}>
            {children}
        </MediaQuery>
    );
};
...
export const PhonePortrait = ({ children, ...props }) => {
    return (
        <MediaQuery maxWidth={phoneMaxWidth} orientation={"portrait"} {...props}>
            {children}
        </MediaQuery>
    );
};
...
export const TabletLandscape = ({ children, ...props }) => {
    return (
        <MediaQuery maxWidth={tabletMaxWidth} orientation={"landscape"} {...props}>
            {children}
        </MediaQuery>
    );
};
...
export const TabletPortrait = ({ children, ...props }) => {
    return (
        <MediaQuery maxWidth={tabletMaxWidth} orientation={"portrait"} {...props}>
            {children}
        </MediaQuery>
    );
};
